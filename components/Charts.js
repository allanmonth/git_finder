  ...
  return (
    <Section>
      <ChartsStyles>
        <div className="chart">
          <header>
            <h2>{intl.get('chart1')}</h2>
          </header>

          <div className="chart-container">
            {langChartError && <p>{intl.get('chart2')}</p>}
        ...
        <div className="chart">
          <header>
            <h2>{intl.get('chart3')}</h2>
          </header>
          <div className="chart-container">
            {starChartError && <p>{intl.get('chart2')}</p>}
        ...
        <div className="chart">
          <header>
            <h2>{intl.get('chart4')}</h2>
          </header>
          <div className="chart-container">
            {thirdChartError && <p>{intl.get('chart2')}</p>}
